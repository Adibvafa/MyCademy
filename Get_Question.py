...
import openai
import random
openai.api_key = "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"
...
def Get_Question(arr):
  ...
  model="gpt-3.5-turbo",
  messages=[{"role": "user", "content": f"Give a multiple choice or true/false question on this paragraph without giving the answer: {paragraph}"}],
  temperature=0.1,
  max_tokens=2300,
  top_p=0.95,
